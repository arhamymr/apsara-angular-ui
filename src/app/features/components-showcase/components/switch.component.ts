...
@Component({
  ...
  imports: [CommonModule, MatSlideToggleModule, MatTabsModule],
  template: `
    <div class="section-container">
      <header class="section-header">
        <h1>Switch</h1>
        <p class="section-description">Switches allow users to toggle between on and off states.</p>
      </header>
      <mat-tab-group [(selectedIndex)]="activeTab" class="section-tabs">
        ...
        <mat-tab label="Code">
          <div class="tab-content"><pre class="code-block"><code>&lt;mat-slide-toggle&gt;Enable notifications&lt;/mat-slide-toggle&gt;
&lt;mat-slide-toggle checked&gt;Dark mode&lt;/mat-slide-toggle&gt;</code></pre></div>
        </mat-tab>
      </mat-tab-group>
    </div>
  `,
...
export class SwitchSectionComponent { activeTab = signal(0); }
